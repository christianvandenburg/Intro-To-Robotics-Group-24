...
# import lab5_joint# can't use this because they forgot to put the main code in a __main__ method
...
for i in range(N_PARTS):
    ...
    robot_parts[i].setVelocity(0)#robot_parts[i].getMaxVelocity() / 2.0)
